...
HOUSING_MENU_KEY = "F8" -- To show the housing menu Default: F1
ID_CARD_MENU_KEY = "F2" -- To show the ID CARD menu
JOB_MENU_KEY = "F3" -- To show the job menu
INVENTORY_KEY = "I" -- To show the inventory Default: F4
SHORTCUT_VIEWER_KEY = "F1" -- To display the shortcuts Default: F8
...
VEHICLE_MENU_KEY = "F8" -- To open the vehicle menu Default: F1
VEHICLE_ENGINE_KEY = "Z" -- To toggle vehicle engine Default: X
VEHICLE_TRUNK_KEY = "O" -- To open the vehicle trunk
VEHICLE_HOOD_KEY = "P" -- To open the vehicle hood Derfault: I
ADMIN_MENU_KEY = "N" -- To show the admin menu
TOGGLE_CHAT_KEY = "Num /" -- To toggle the chat
ANIMATION_HANDSUP_KEY = "X" -- HANDSUP // aqui
...
function GetAllKeybinds()
    return {
        ...
        {label = _("ADMIN_MENU_KEY"), key = ADMIN_MENU_KEY},
		{label = _("ANIMATION_HANDSUP_KEY"), key = ANIMATION_HANDSUP_KEY},
		{label = _("VEHICLE_RADIO_KEY"), key = VEHICLE_RADIO_KEY},
		{label = _("VEHICLE_RADIO_LOWER_KEY"), key = VEHICLE_RADIO_LOWER_KEY},
		{label = _("VEHICLE_RADIO_INCREASE_KEY"), key = VEHICLE_RADIO_INCREASE_KEY},
    }
end
