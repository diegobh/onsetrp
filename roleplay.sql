...
INSERT INTO `items` (`id`, `name`, `category`, `subcategory`, `price`, `weight`, `hunger`, `thirst`, `equipable`, `usable`) VALUES
	...
	(NULL, 'mask_4', 'masks', 'object', 7000, 100, 0, 0, 1, 0),
  	(NULL, 'mag_deagle', 'weapons', 'weapon', 80, 170, 0, 0, 0, 1),
  	(NULL, 'mag_m1911', 'weapons', 'weapon', 50, 100, 0, 0, 0, 1),
  	(NULL, 'mag_glock', 'weapons', 'weapon', 50, 130, 0, 0, 0, 1),
  	(NULL, 'mag_m9', 'weapons', 'weapon', 50, 120, 0, 0, 0, 1),
  	(NULL, 'mag_shotgun', 'weapons', 'weapon', 65, 150, 0, 0, 0, 1),
  	(NULL, 'mag_mp5', 'weapons', 'weapon', 60, 140, 0, 0, 0, 1),
  	(NULL, 'mag_mac10', 'weapons', 'weapon', 55, 130, 0, 0, 0, 1),
 	(NULL, 'mag_ump45', 'weapons', 'weapon', 60, 150, 0, 0, 0, 1),
  	(NULL, 'mag_m4', 'weapons', 'weapon', 100, 250, 0, 0, 0, 1),
  	(NULL, 'mag_ak', 'weapons', 'weapon', 80, 250, 0, 0, 0, 1),
  	(NULL, 'mag_g36', 'weapons', 'weapon', 100, 250, 0, 0, 0, 1),
  	(NULL, 'mag_asval', 'weapons', 'weapon', 60, 150, 0, 0, 0, 1),
  	(NULL, 'mag_aks', 'weapons', 'weapon', 70, 200, 0, 0, 0, 1),
  	(NULL, 'mag_g3', 'weapons', 'weapon', 90, 270, 0, 0, 0, 1),
  	(NULL, 'mag_acr', 'weapons', 'weapon', 100, 250, 0, 0, 0, 1),
  	(NULL, 'mag_hk', 'weapons', 'weapon', 90, 200, 0, 0, 0, 1),
  	(NULL, 'mag_l96', 'weapons', 'weapon', 150, 300, 0, 0, 0, 1),
  	(NULL, 'mag_tazer', 'weapons', 'weapon', 70, 100, 0, 0, 0, 1);
